...
% posterior inference
[store_B,store_z,store_phi,store_q,store_R2,store_gam,store_s2,y,x,u,T,k]=SpikeSlabGLP_t2(y,x,u,abeta,bbeta,Abeta,Bbeta,M,N,3);



% saving the results
save ('C:\LMU\1-2\Seminar\Paper\Additional Analysis\Additional_Analysis\Students_t\Estimation Resuts\Macro1_PosteriorDraws')

clear all
close all


cd ('C:\LMU\1-2\Seminar\Paper\Additional Analysis\Additional_Analysis\Students_t\Estimation Resuts'); 
